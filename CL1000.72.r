...
write.table(data.frame(alpha,times),file="CL1000.8.txt")
write.table(data.frame(alpha,times),file="CL1000.8.Fst.txt")

for(i in 1:length(times)){
	B1000=Bottle12(r=.001,K=100,L=9,m=m,mu=1/100,time=times[i],n=16,b=Nb,r2=.001,K2=8)
	write.table(B1000$data,file="CL1000.8.txt",append=TRUE)
	write.table(B1000$Fst,file="CL1000.8.Fst.txt",append=TRUE)
	}
